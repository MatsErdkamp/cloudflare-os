...
// Blueprints, AI providers) uses the same compact, on-language menu instead of the previous library's larger
...
export const MENU_CONTENT =
  'themed-floating-shadow !z-[1100] !min-w-[180px] rounded-lg border border-border bg-background p-1 outline-none focus:outline-none focus-visible:outline-none'

// the previous UI library portals the menu to document.body and applies MENU_CONTENT's className to the *inner* popup,
...
export const MENU_ITEM_DANGER =
  '!h-auto rounded-md !px-2.5 !py-1.5 text-[13px] leading-[18px] tracking-[-0.25px] data-highlighted:bg-destructive-muted'
